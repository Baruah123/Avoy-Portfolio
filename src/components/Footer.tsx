  ...
  return (
    <footer className="bg-slate-900 py-12 relative">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-2">
              <span className="text-teal-400">Avoy</span>Portfolio
            </h3>
          ...
          >
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-teal-400 transition-colors">
        ...
        >
          <p className="text-gray-400 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} AvoyPortfolio. All rights reserved.
          </p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a href="#skills" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">Skills</a>
            <a href="#projects" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">Projects</a>
            <a href="#experience" className="text-gray-400 hover:text-teal-400 transition-colors text-sm">Experience</a>
      ...
      <motion.button
        ...
        onClick={scrollToTop}
        className="absolute right-6 bottom-6 w-12 h-12 bg-teal-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-teal-600 transition-colors"
      >
        <ArrowUp size={20} />
      </motion.button>
    </footer>
